...
table(my_data_calculated$menopause)
# 计算是否吸烟
my_data_calculated <- my_data_calculated %>%
    mutate(
        smoke = case_when(
...
table(my_data_calculated$smoke)
# 导出疾病情况数据
disease_data <- my_data_calculated %>%
    select(
        ...
        stroke, kidney_disease, digestive_system_disease,
        emotional_and_mental_issues, diseases_related_to_memory,
        diseases_arthritis, asthma, number_chronic_disease,
...
write_parquet(disease_data, "data_export/data_calculated/data_calculated_disease.parquet")
