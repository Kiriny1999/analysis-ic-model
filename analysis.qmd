...
write_parquet(demographic_data, "data_export/demographic_data.parquet")
...
write_parquet(physiological_data, "data_export/physiological_data.parquet")
...
family_structure_data <- my_data_calculated %>%
    select(
        ID, num_parents_alive, num_children, totalnum_children_alive,
        married_children_ratio, total_number_grandchildren,
        total_number_great_grandchildren
    )

write_parquet(family_structure_data, "data_export/family_structure_data.parquet")
```
...
write_parquet(caregiving_burden_data, "data_export/caregiving_burden_data.parquet")
```
...
write_parquet(medical_insurance_data, "data_export/medical_insurance_data.parquet")
