...
feature_labels_en <- c(
  ...
  "number_pain_locations" = "Pain locations (count)",
  "number_grandchildren_great_grandchildren" = "Grandchildren (count)",
  "waist_circumference" = "Waist circumference",
  "education_level" = "Education level",
  "triglycerides" = "Triglycerides",
  "uric_acid" = "Uric acid",
  "year_smoke" = "Years of smoking",
  "health_satisfaction" = "Health satisfaction",
  "number_chronic_disease" = "Chronic diseases (count)",
  "year_diseases_arthritis" = "Years with arthritis",
  "health_compared" = "Health vs 2 years ago",
  "number_social_activities" = "Social activities (count)",
  "life_satisfaction" = "Life satisfaction",
  "number_smoke" = "Cigarettes (count)",
  "treat_pain_无疼痛" = "Pain treatment: No pain",
  "treat_pain_有疼痛且治疗" = "Pain treatment: Treated",
  "treat_pain_有疼痛不治疗" = "Pain treatment: Not treated",
  "address_urban_or_rural_主城区" = "Residence: Urban core",
  "address_urban_or_rural_城乡结合部" = "Residence: Urban-rural fringe",
  "address_urban_or_rural_镇中心" = "Residence: Town center",
  "address_urban_or_rural_镇乡" = "Residence: Township",
  "address_urban_or_rural_特殊区域" = "Residence: Special area",
  "address_urban_or_rural_乡中心" = "Residence: Rural center",
  "address_urban_or_rural_村庄" = "Residence: Village",
  "literate_不识字" = "Literacy: Illiterate",
  "literate_识字" = "Literacy: Literate",
  "martial_status_已婚与配偶一同居住" = "Marital: Married (co-residing)",
  "martial_status_已婚但配偶暂时不在一起居住" = "Marital: Married (separated)",
  "martial_status_已婚但配偶在外地工作" = "Marital: Spouse away for work",
  "martial_status_离异" = "Marital: Divorced",
  "martial_status_丧偶" = "Marital: Widowed",
  "martial_status_从未结婚" = "Marital: Never married",
  "martial_status_同居" = "Marital: Cohabiting"
)
